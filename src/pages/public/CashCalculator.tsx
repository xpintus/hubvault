...
export default function CashCalculator() {
  ...
  useEffect(()=>{if(!hasAnnouncedRef.current){hasAnnouncedRef.current=true;return;}if(collected<=0)return;const timer=window.setTimeout(()=>announceTotal(collected),1000);return()=>window.clearTimeout(timer);},[collected,announceTotal]);
