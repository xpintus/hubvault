...
const INDEXABLE_PATHS = new Set(['/','/buy-hubvault','/about','/tools/cash-calculator','/tools/cod-reconciliation-calculator','/tools/route-load-distributor','/collection-reconciliation-software','/cod-reconciliation-software','/daily-closing-software','/logistics-cash-collection-software']);
